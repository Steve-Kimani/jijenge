...
$connect = new mysqli($_POST['dbHost'], $_POST['dbUser'], $_POST['dbPass']);

if (!$connect) {
    error_log("Failed to connect to MySQL: " . mysqli_error($connect));

    die('Internal server error');
}
  if($connect) {
	if(mysqli_select_db($connect, $_POST['dbName'])) {
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<title>jijenge Installation</title>
	...
	<link href="<?php echo $approot; ?>/themes/jijenge/css/login.css" type="text/css" rel="stylesheet">
    </head>
...
<div class ="install-header" >
   ...
   <div class="content" style="height: 400px; width: 600px; margin: 100px auto; ">
	...
	<div class="install-instruct" style="float: left; height: 350px; width: 205px;">
		...
		<span>Welcome to the jijenge application installer! We need to collect a little information before we can get your application up and running.</span>
	 </div>
       </div>
