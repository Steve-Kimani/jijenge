  ...
  <?php 
	...
	$login_user_name = '';
		...
		<?php echo '<div class="right-menu-link"><ul id ="nav"><li class="welcome">Welcome, '. $login_user_name.'</li>';
			echo '<li>'.CHtml::link('jijenge Support','http://124.125.156.120:8081', array('target'=>'_blank'))."</li>";
...
?>
	...
	<div id="footer">
<div class="powered-by"><span class="powered-text">© Copyright 2013 Digital Cloud Bytes. All Rights Reserved.
