...
class StudentTransaction extends CActiveRecord
{
	...
	{
		return array(
			array('student_transaction_student_photos_id,student_transaction_batch_id,academic_term_period_id,academic_term_id,course_id', 'required','message'=>''),
			...
			array('student_transaction_id, student_transaction_user_id, student_transaction_student_id, student_transaction_student_address_id, student_transaction_nationality_id, student_transaction_languages_known_id, student_transaction_student_photos_id, student_transaction_batch_id, student_first_name, student_middle_name,title, batch_name, student_last_name, user_organization_email_id, student_roll_no, student_mobile_no, student_email_id_1', 'safe', 'on'=>'search, takeFees, leftStudentSearch,hostelsearch,smssearch,transportsearch,resetloginstudentsearch,feessearch,allstudent, multipleDivBatchAssign'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->with = array('Rel_Stud_Info','Rel_language','Rel_user','Rel_Batch','Rel_course');
		...
		$criteria->compare('Rel_Batch.batch_name',$this->student_transaction_batch_id,true);
		$criteria->compare('Rel_course.course_name',$this->course_id,true);
	...
	public static function getExportData() {
		...
		'filename'=>'Student Details', 'pdfFile'=>'student.views.studentTransaction.StudentTransactionExportPdf');
	      ...
	      $data = array('data'=>$_SESSION['exportData'],'attributes'=>array(
			...
			'Rel_language.languages_known1',
			//'Rel_language.Rel_Langs2.languages_name',
			//'Rel_language.Rel_Langs3.languages_name',
			//'Rel_language.Rel_Langs4.languages_name',
			'Rel_Student_Address.student_address_c_line1::Current Address Street 1',
			'Rel_Student_Address.student_address_c_line2::Current Address Street 2',
			'Rel_Student_Address.Rel_c_city.city_name::Current Address Town',
			'Rel_Student_Address.student_address_c_pin::Current Address Town Pin ',
			...
			'Rel_Student_Address.student_address_c_phone',
			'Rel_Student_Address.student_address_c_mobile',
			'Rel_Student_Address.student_c_house_no',
			'Rel_Student_Address.student_address_p_line1::Permanent Address Street 1',
			'Rel_Student_Address.student_address_p_line2::Permanent Address Street 2',
			'Rel_Student_Address.Rel_p_city.city_name::Permanent Address Town',
