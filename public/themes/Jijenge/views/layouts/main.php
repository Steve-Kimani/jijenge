...
<div class="header navbar navbar-inverse navbar-fixed-top">
	...
	<!--div class="edu-logo"><?php //echo CHtml::link(CHtml::image(Yii::app()->baseUrl.'/images/jijenge.png', 'jijenge'), 'http://www.rudrasoftech.com', array('target'=>'_blank')); ?></div-->
...
<div class="footer">
	©  <?php echo date('Y')?> design by Digital Cloud Bytes, All right Reserved.
</div>
