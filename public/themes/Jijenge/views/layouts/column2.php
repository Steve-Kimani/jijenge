...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>jijenge Management System - Dashboard</title>
...
<div class="powered-by"><span class="powered-text" style="margin-right: 15px;">&copy; Copyright <?php echo date('Y'); ?> Digital Cloud Bytes. All Rights Reserved.
</span></div>
</div>
    </div>
